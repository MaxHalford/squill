...
describe('isFixableError', () => {
  ...
  describe('Case insensitivity', () => {
    it('matches patterns case-insensitively', () => {
      expect(isFixableError('CONNECTION REFUSED', 'bigquery')).toBe(false)
      expect(isFixableError('Authentication Failed', 'bigquery')).toBe(false)
  ...
  describe('Exact message matches', () => {
    it('returns false for "Query execution failed:"', () => {
      expect(isFixableError('Query execution failed:', 'bigquery')).toBe(false)
    })
  })
})
