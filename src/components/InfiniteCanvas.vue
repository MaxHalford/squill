...
// Zoom uses transform: scale() exclusively. CSS zoom can make
// getBoundingClientRect() and pointer coordinates use different scales, breaking
// interactions such as CodeMirror selection and tooltips.
...
<style scoped>
.infinite-canvas {
  --font-family-ui: var(--font-family-mono);
  position: fixed;
  inset: 0;
  overflow: hidden;
